"""Re-write mmdeploy/codebase/mmdet/models/detectors/two_stage.py for otx."""
...
@FUNCTION_REWRITER.register_rewriter("mmdet.models.detectors.two_stage.TwoStageDetector.extract_feat")
...
@FUNCTION_REWRITER.register_rewriter("mmdet.models.detectors.two_stage.TwoStageDetector.forward")
def two_stage_detector__forward(
    ...
    Args:
        self (TwoStageDetector): TwoStageDetector class object.
